...
class JElementK2Categoriesmultiple extends JElement
{
...
$k2_check = JFolder::exists(JPATH_ROOT.DS."components".DS."com_k2".DS);
	if($k2_check):
		...
		$output= '
<select id="paramscategory_id" class="inputbox" size="10" multiple="multiple" style="width:90%;" name="params[category_id][]" disabled="disabled">
