	...
	start: function(){
		...
		*/
		this.slides.each(function(slide, i){
			...
			this.slides[i]['fx'] = new Fx.Styles(slide, {duration: this.options.slides.fadeDurr, transition: Fx.Transitions.linear, wait:false});
			...
			if( this.options.slides.infoContainer && this.options.slides.infoContainerPosition ){
				...
				var infoFx = new Fx.Style(info, this.options.slides.infoContainerPosition, {duration: this.options.slides.fadeDurr, wait:false});
				//infoFx.set(-500);
